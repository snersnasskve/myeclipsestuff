...
public class ContactActivity extends Activity {
	...
	//	ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
		...
		ArrayAdapter<String> countriesAdapter = new ArrayAdapter<String>(this, R.layout.list_item, R.array.countries);
		actvCountry.setAdapter(countriesAdapter);
		
		actvCountry.setOnItemClickListener(new OnItemClickListener() {
