...
import com.kve.rainforecast3.data.WeatherData;
import com.kve.rainforecast3.location.ForecastLocation;
import com.kve.rainforecast3.location.WeatherLocation;
import com.kve.rainforecast3.view.*;
...
public class ForecastMainActivity extends FragmentActivity  {
	...
	public static ForecastReader	forecastReader;		//	Data needs to be omnipresent
	...
	private void showCurrentWeather(String weatherJson)
 	{
 		if (null != weatherJson)
 		{
			...
			//Intent currentIntent = new Intent(ForecastMainActivity.this, WeatherDashboard.class);
 			...
 			currentIntent.setClassName(ForecastMainActivity.this, "com.kve.rainforecast3.view.WeatherDashboard");
