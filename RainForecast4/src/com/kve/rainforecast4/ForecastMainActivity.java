...
import com.kve.rainforecast4.location.ForecastLocation;
import com.kve.rainforecast4.location.WeatherLocation;
    ...
    private boolean getLocationFromAddress()
    {
       ...
       pbReadWeather.setVisibility(View.VISIBLE);
    	...
    	if (etLocationPlaceName.getText().toString().length() > 3)
    	{
    		...
    		{
    			statusString = "Location for address NOT found";
    		}
    	}
    	else
    	{
	...
	private void showCurrentWeather(String weatherJson)
 	{
 		if (null != weatherJson)
 		{
			...
			//Intent currentIntent = new Intent(ForecastMainActivity.this, WeatherDashboard.class);
 			...
 			currentIntent.setClassName(ForecastMainActivity.this, "com.kve.rainforecast4.view.ForecastTabHolder");
