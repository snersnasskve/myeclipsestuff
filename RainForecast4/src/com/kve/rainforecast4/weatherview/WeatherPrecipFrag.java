...
public class WeatherPrecipFrag extends WeatherFrag {
	...
	@Override
		...
		return inflater.inflate(R.layout.precip_chart, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
	    ...
	    ivPcIntensity	= (ImageView) getActivity().findViewById(R.id.ivPcIntensity);
	    ivPcProbability	= (ImageView) getActivity().findViewById(R.id.ivPcProbability);
	    tvPcIntensity	= (TextView)  getActivity().findViewById(R.id.tvPcIntensity);
